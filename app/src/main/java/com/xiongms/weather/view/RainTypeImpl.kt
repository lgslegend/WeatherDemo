package com.xiongms.weather.view
...
class RainTypeImpl(
    ...
    init {
        longCloud = context.getDrawable(R.drawable.od_rainday_long_cloud)
        longCloud1 = context.getDrawable(R.drawable.od_rainday_long_cloud)
        shortCloud = context.getDrawable(R.drawable.od_rainday_short_cloud)
        lighting = context.getDrawable(R.drawable.od_rain_day_lighting)
